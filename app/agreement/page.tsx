      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-sm leading-relaxed text-neutral-300 space-y-6">
          ...
          <section>
            ...
            <p>
              ВОЗВРАТ СРЕДСТВ НЕ ОСУЩЕСТВЛЯЕТСЯ. В связи с цифровой природой продукта и возможностью мгновенного 
              доступа к материалам после покупки, возврат средств не производится 
              ни при каких обстоятельствах. Покупая книгу, Студент подтверждает, 
              что ознакомился с содержанием и согласен с данным условием.
            </p>
          </section>
